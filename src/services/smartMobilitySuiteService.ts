...
export const PRESET_SIMULATION_SCENARIOS: SimulationScenario[] = [
  {
    ...
    impactedRoutes: ['Route 16', 'Route 11', 'Route 13', 'Route 24'],
  ...
  },
  {
    ...
    impactedRoutes: ['Route 09', 'Route 16', 'Route 12', 'Route 26'],
...
export const SAMPLE_SMART_STOPS: SmartStopChoice[] = [
  {
    ...
    crowdLabel: 'Low',
    availableRoutes: ['Route 16', 'Route 11', 'Route 26'],
    isRecommended: true,
