...
<img src="/public/musafir-logo.png" alt="Musafir Logo" width="120" style="border-radius: 24px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);"/>
...
[![Vite 6](https://img.shields.io/badge/Vite-6.x-646CFF?style=flat-square&logo=vite&logoColor=white)](https://vitejs.dev/)
[![Tailwind CSS 3.4](https://img.shields.io/badge/TailwindCSS-3.4-38B2AC?style=flat-square&logo=tailwind-css&logoColor=white)](https://tailwindcss.com/)
...
[![Leaflet Maps](https://img.shields.io/badge/Leaflet-1.9_Vector_HUD-199900?style=flat-square&logo=leaflet&logoColor=white)](https://leafletjs.com/)
...
[![Express.js](https://img.shields.io/badge/Node.js-Express_Backend-000000?style=flat-square&logo=express&logoColor=white)](https://expressjs.com/)
[![PWA Ready](https://img.shields.io/badge/Mobile-Responsive_PWA-FF6F00?style=flat-square&logo=pwa&logoColor=white)](https://web.dev/progressive-web-apps/)
...
```mermaid
flowchart TB
    subgraph Client["📱 Commuter Client (React 19 + TypeScript + Vite)"]
        UI["🎨 Glassmorphic Responsive Dashboard"]
        subgraph Modules["Interactive Feature Modules"]
            Planner["🗺️ 1-Tap Multi-Modal Planner"]
            MapEngine["🛰️ Dual 3D HUD & Leaflet Engine"]
            AICopilot["🤖 Gemini 2.5 Multilingual Voice Assistant"]
            FareCalc["🧮 Dynamic Geodesic Fare Matrix"]
            SafetySOS["🚨 Mid-Road Trauma SOS & Medical ID"]
            LogisticsTSP["📦 Cargo & Multi-Stop TSP Optimizer"]
            CivicHub["👥 Civic Community & Incident Radar"]
            NewsFeed["📰 Live Google News Commuter RSS"]
        end
        UI --> Modules
    end

    subgraph Backend["⚡ Express.js Microservices Layer"]
        HealthAPI["/api/health"]
        ProfileAPI["/api/users/profile"]
        TripsAPI["/api/trips"]
        NewsAPI["/api/alerts/live-news"]
        GeocodeAPI["/api/geocode"]
    end

    subgraph External["🌐 Cloud & AI Services"]
        Gemini["🧠 Google Gemini 2.5 Flash API"]
        GoogleMaps["📡 Google Maps Live Traffic & Tiles"]
        Supabase["🗄️ Supabase PostgreSQL & Auth"]
        GovNews["📰 Google News Regional RSS Feed"]
    end
